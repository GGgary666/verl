...
EXP_NAME=qwen3_1_7B_qat_w4a4_mathlighteval
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/xpfs/fp4/gg/datasets/MATH-lighteval/train.parquet \
    data.val_files=/xpfs/fp4/gg/datasets/MATH-lighteval/test.parquet \
