...
EXP_NAME=qwen3_1_7B_qat_w4a4_baseline_17kdata
...
max_response_length=$((1024 * 20))   # 4096 for quick validation; use 1024*20 for full run
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/xpfs/fp4/gg/datasets/DAPO-Math-17k/data/dapo-math-17k.parquet \
    data.val_files=/xpfs/fp4/gg/datasets/AIME-2024/data/aime-2024.parquet \
    ...
    trainer.total_epochs=3 $@ | tee -a $ROOT_DIR/$EXP_NAME.log