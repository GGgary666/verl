#!/usr/bin/env bash
# PPO + QAT W4A16 (Weight-only NVFP4) for Qwen2.5-0.5B-Instruct on GSM8K
# QAT 配置参考: recipe/qat/run_qwen3_30b_w4a16.sh
set -x
...
EXP_NAME=ppo_qwen2_5_0_5b_qat_w4a16_baseline

# QAT: w4a16 (ref: recipe/qat/config/nvfp4_w4a16.json)
VERL_ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
qat_config_path="${qat_config_path:-"${VERL_ROOT}/recipe/qat/config/nvfp4_w4a16.json"}"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/xpfs/fp4/models/Qwen2.5-0.5B-Instruct \
    ...
    critic.model.path=/xpfs/fp4/models/Qwen2.5-0.5B-Instruct \
